/* autogenerated by Processing revision 1274 on 2022-03-08 */
...
public class Chess_Clock extends PApplet {
...
// Function to convert time in seconds to a string with the time in minutes and seconds (MM:SS)
 public String convertSeconds(int t){
...
// Function to turn the current side being changed into a string
 public String stringChange(){
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Chess_Clock" };
    if (passedArgs != null) {
